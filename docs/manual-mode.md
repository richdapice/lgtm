...
With a `TYPESAFE_API_KEY` set, a line under the finding says what Jev makes of it (`jev: accept (91% sure) · 14% real`) and the action cursor starts on its suggestion. See [triage](configuration.md#triage).
